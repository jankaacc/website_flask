...
Revision ID: f2e1e0b980f4
Revises: 
Create Date: 2017-10-12 14:53:29.257140
...
def upgrade():
    ...
    sa.Column('intrests', sa.Text(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['admin'], ['author.user_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
